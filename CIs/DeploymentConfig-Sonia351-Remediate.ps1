...
#Unpublish-AppvClientPackage -PackageId $PackageID -VersionId $VersionID -Verbose
Publish-AppvClientPackage -PackageId $PackageID -VersionId $VersionID -DynamicUserConfigurationPath $NewConfigPath.FullName -Verbose
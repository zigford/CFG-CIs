...
function Set-BiosAttribute {
    ...
    Process {
        ...
        If ($CurrentAttribute.PossibleValuesDescription.Count -eq 1 -and $CurrentAttribute.PossibleValuesDescription -match '-') {
            ...
            # The value is not a range but a description of a possible value, calculate the index of possible value
            Write-Debug "Detected possible values as description."
